...
Webflow.require('ix').init([
  {"slug":"show-vote-ballot-for-mobile","name":"Show Vote Ballot for Mobile","value":{"style":{},"triggers":[{"type":"click","selector":".vote","stepsA":[{"display":"inline-block"}],"stepsB":[]}]}},
  {"slug":"scrolling-ballot","name":"Scrolling Ballot","value":{"style":{"x":"0px","y":"0px"},"triggers":[{"type":"scroll","selector":".vote","offsetTop":"10%","offsetBot":"10%","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"100%"}]}]}},
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{},"triggers":[{"type":"click","selector":".vote","stepsA":[{"display":"none"}],"stepsB":[]}]}}
]);
